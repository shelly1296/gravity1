 ...
 *
 * The 3-dimensional vector represents a standard Cartesian vector given by
 * x<b>i</b> + y<b>j</b> +z<b>k</b> where <b>i</b>, <b>j</b>, and <b>k</b> are
...
public class PhysicsVector {
	...
	// In this case we have a three dimensional vector, the x component is [0]
	// with y[1] and z[2]
	...
	/**
	 * Constructor that takes two arguments to create a PhysicsVector with the
	 * first argument x giving the component in the <b>i</b> direction and the
	 * second argument y giving the component in the <b>j</b> direction. The z
	 * component is set to zero.
	 *
	 * @param x
	 *            <code>x-component</code> of the vector
	 * @param y
	 *            <code>y-component</code> of the vector
	 **/
	...
	/**
	 * Constructor that takes three arguments to create a PhysicsVector with the
	 * first argument giving the component in the <b>i</b> direction, the second
	 * argument giving the component in the <b>j</b> direction and the third
	 * argument giving the component in the <b>k</b> direction.
	 *
	 * @param x
	 *            <code>x-component</code> of the vector
	 * @param y
	 *            <code>y-component</code> of the vector
	 * @param z
	 *            <code>z-component</code> of the vector
	 **/
	 ...
	 * only the x and y components. Returns a default vector if the array is not
	 * length 2 or 3 and prints a warning message. (NB It would be better to
	 * 'throw an exception' here if you know how to do it!)
	 *
	 * @param x
	 *            array whose components will be transferred to the vector
	 **/
	...
	/**
	 * Method to return a String which represents the vector in 2D and has the
	 * form x<b>i</b> + y<b>j</b>.
	 * 
	...
	/**
	 * Method to return a String which represents the vector in 2D and has the
	 * form "x y"(I.e. coordinates separated by spaces).
	 * 
	...
	/**
	 * Method to return a String which represents the vector in 3D and has the
	 * form x<b>i</b> + y<b>j</b> +z<b>k</b>.
	 * 
	...
	/**
	 * Method to return a String which represents the vector in 3D and has the
	 * form "x y z" (I.e. coordinates separated by spaces).
	 * 
	...
	/**
	 * prints the 2D vector to 'standard out'. Note: it will include a carriage
	 * return. Prints: "xi + yj" for coordinates x and y.
	 **/
	public void print2D() {
	...
	/**
	 * prints the 3D vector to 'standard out'. Note: it will include a carriage
	 * return. Prints: "xi + yj + zk" for coordinated x,y and z.
	 **/
	public void print() {
	...
	/**
	 * Change the value of the vector to x<b>i</b> + y<b>j</b>. The z-component
	 * is set to zero.
	 *
	 * @param x
	 *            new x-component of the vector
	 ...
	 *
	 * @param v
	 *            the vector whose values are copied to <code>this</code>
	 *            vector.
	 **/
	...
	public static PhysicsVector vectorProduct(PhysicsVector u, PhysicsVector v) {
		...
		product.vectorComponents[0] = u.vectorComponents[1] * v.vectorComponents[2]
				- u.vectorComponents[2] * v.vectorComponents[1];
		product.vectorComponents[1] = u.vectorComponents[2] * v.vectorComponents[0]
				- u.vectorComponents[0] * v.vectorComponents[2];
		product.vectorComponents[2] = u.vectorComponents[0] * v.vectorComponents[1]
